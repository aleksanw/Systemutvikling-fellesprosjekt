...
public class EventTest extends JFCTestCase {
	public void testWithoutDB() throws Exception {
		...
		assertEquals(new DateTime("2013-03-15T12:15:00").toString(), event
				.getStart().toString());
		assertEquals(new DateTime("2013-03-15T15:00:00").toString(), event
				.getEnd().toString());
	...
	public void testSimpleGroupAvtale() throws Exception {
		...
		assertEquals(new DateTime("2013-03-15T12:15:00").toString(),
				eventFromDB.getStart().toString());
		assertEquals(new DateTime("2013-03-15T15:00:00").toString(),
				eventFromDB.getEnd().toString());
	...
	public void testMeeting() throws Exception {
		...
		// Book a Room
		ArrayList<Room> rooms = client.roomStorage.getRoomList().getList();
		event.setRoomBooked(rooms.get(0));
		...
		assertEquals(currentUser.getUserID(), eventFromDB.getCreatedByUser()
				.getUserID());
